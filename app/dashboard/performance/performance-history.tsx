  ...
  return (
    <main className="user-shell performance-shell">
      <aside className="user-sidebar">
        ...
        <nav><a href="/dashboard"><LayoutDashboard size={18} />Genel bakış</a><a href="/dashboard#matches"><CalendarDays size={18} />Maç analizleri</a><a className="active" href="/dashboard/performance"><LineChart size={18} />Performans geçmişi</a><a href="/dashboard/bankroll"><WalletCards size={18} />Kasa ve kupon</a><a href="/dashboard/notifications"><Bell size={18} />Bildirimler</a></nav>
      ...
      <section className="user-main">
        ...
        <section className="performance-policy"><ShieldCheck size={16} /><p>Yayın anındaki oran, de-vig değer kanıtı ve kişisel kasa hareketleri artık kalıcıdır. ROI, kişisel bahis kayıtları sonuçlandıkça; CLV ise kapanış oranı snapshotı geldikçe hesaplanır.</p><span>VALUE + BANKROLL ACTIVE</span></section>
      ...
      <nav className="user-mobile-nav"><a href="/dashboard"><LayoutDashboard size={19} /><span>Ana sayfa</span></a><a className="active" href="/dashboard/performance"><LineChart size={19} /><span>Geçmiş</span></a><a href="/dashboard/bankroll"><WalletCards size={19} /><span>Kasa</span></a><a href="/dashboard/notifications"><Bell size={19} /><span>Bildirim</span></a></nav>
    </main>
  );
}
