  ...
  return (
    <main className="user-shell performance-shell">
      <aside className="user-sidebar">
        ...
        <nav><a href="/dashboard"><LayoutDashboard size={18} />Genel bakış</a><a href="/dashboard#matches"><CalendarDays size={18} />Maç analizleri</a><a className="active" href="/dashboard/performance"><LineChart size={18} />Performans geçmişi</a><span><WalletCards size={18} />Kişisel kasa<em>CP13</em></span></nav>
